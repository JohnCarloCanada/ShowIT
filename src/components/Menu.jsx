...
const Menu = ({ nav }) => {
  return (
    <section
      className={
        nav
          ? "fixed overflow-hidden w-[50%] h-[50%] top-0 right-0 bg-[#3a3a3c] flex items-center justify-between flex-col py-10 px-4 gap-4 md:hidden duration-300 ease-out z-15"
